...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/png/ui/png/ic_save_black_24dp.png"), QSize(), QIcon::Normal, QIcon::Off);
        action_Save_Diagram->setIcon(icon);
        actionNew_Diagram = new QAction(MainWindow);
        actionNew_Diagram->setObjectName(QStringLiteral("actionNew_Diagram"));
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/png/ui/png/ic_create_new_folder_black_24dp_1x.png"), QSize(), QIcon::Normal, QIcon::Off);
